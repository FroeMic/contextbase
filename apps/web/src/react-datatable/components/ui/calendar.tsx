...
function Calendar({
  ...
  const DayButtonComponent = React.useMemo(() => {
    function DayButtonComponent(props: React.ComponentProps<typeof DayButton>) {
      return <CalendarDayButton {...props} dayFontSize={dayFontSize} />
    }
    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "h-[var(--cell-size)] w-[var(--cell-size)] select-none p-0 aria-disabled:opacity-50 h-8 w-8",
        ...
        dropdowns: cn(
          "flex h-[var(--cell-size)] w-full items-center justify-center gap-1.5 text-xs font-medium",
        ...
        weekday: cn(
          "text-muted-foreground flex-1 select-none text-xs font-medium w-[var(--cell-size)] flex items-center justify-center",
...
function CalendarDayButton({
  ...
  dayFontSize = "text-xs",
  ...props
}: React.ComponentProps<typeof DayButton> & { dayFontSize?: string }) {
  const defaultClassNames = getDefaultClassNames()
